...
:: ---------------------------------------------------------------------
SET VM_OPTIONS_FILE=%ANDROID_STUDIO_VM_OPTIONS%
IF "%VM_OPTIONS_FILE%" == "" SET VM_OPTIONS_FILE=%IDE_BIN_DIR%\studio%BITS%.exe.vmoptions
SET ACC=
...
SET COMMON_JVM_ARGS="-Xbootclasspath/a:%IDE_HOME%/lib/boot.jar" -Didea.paths.selector=AndroidStudioBeta %IDE_PROPERTIES_PROPERTY%
